...
const COMMON = [
   {
		"id": "poison_kit",
		"name": "Slimy Satchel",
		"image": preload("res://assets/images/artifacts/comum.png"),
...
const UNCOMMON = [
	{
		...
		"image": preload("res://assets/images/artifacts/incomum.png"),
...
const RARE = [
	{
		"id": "buff_heal",
		"name": "Ivory Cup",
		"image": preload("res://assets/images/artifacts/raro.png"),

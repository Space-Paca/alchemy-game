...
const DB = {
	"common": {
		"name": "Comum",
		"image": preload("res://assets/images/reagents/3 dano aleatorio.png"),
	...
	"uncommon": {
		...
		"image": preload("res://assets/images/reagents/incomum 5 dano.png"),
		"tooltip" : "If not used correctly, deals %s regular damage to a random enemy.",
	...
	"damaging": {
		...
		"image": preload("res://assets/images/reagents/3 dano  todos.png"),
	...
	"defensive": {
		...
		"image": preload("res://assets/images/reagents/3 defesa.png"),
	...
	"super_damaging": {
		...
		"image": preload("res://assets/images/reagents/mais dano.png"),
		"tooltip" : "If not used correctly, deals %s regular damage to all enemies.",
	...
	"super_defensive": {
		...
		"image": preload("res://assets/images/reagents/mais defesa.png"),
		"tooltip" : "If not used correctly, gives %s shield to user.",
	...
	"healing": {
		"name": "Reagente Cura",
		"image": preload("res://assets/images/reagents/2 cura.png"),
	...
	"poison": {
		...
		"image": preload("res://assets/images/reagents/poison 2dano.png"),
	...
	"buff": {
		"name": "Reagente Buff",
		"image": preload("res://assets/images/reagents/x.png"),
	...
	"trash": {
		"name": "Reagente Lixo",
		"image": preload("res://assets/images/reagents/lixo 1 dmg.png"),

...
var states = {
	"easy": ["init", "attack1", "defend", "attack2"],
...
var actions = {
	"easy": {
		"init": [
			{"name": "status", "status_name": "avenge", "value": 16, "target": "self", "positive": true, "animation": "taunt"}
		],
		"attack1": [
			{"name": "damage", "value": [27, 30], "type": "regular", "animation": "atk3_arc"}
		],
		"attack2": [
			{"name": "damage", "value": [10, 16], "amount": 2, "type": "regular", "animation": "atk2"}
		],
		"defend": [
			{"name": "shield", "value": [10, 18], "animation": "defense"},
		],
	},
	"normal": {
		"init": [

...
var states = {
	"easy": ["start", "attack1", "attack2", "attack3", "attack4", "init",\
...
var actions = {
	"easy": {
		"init": [
			{"name": "shield", "value": 140, "animation": ""},
		],
		"start": [
			{"name": "shield", "value": 100, "animation": ""},
			{"name": "status", "status_name": "deviation", "value": 1, "target": "player", "positive": false, "animation": ""},
			{"name": "status", "status_name": "divine_protection", "value": 80, "target": "self", "positive": true, "extra_args": {"value": 60}, "animation": ""},
		],
		"attack1": [
		...
		"attack4": [
			{"name": "drain", "value": 50, "animation": "02_atk"},
			{"name": "shield", "value": [50,60], "animation": ""},
		],
		"debuff1": [
			{"name": "status", "status_name": "burning", "value": 10, "target": "player", "positive": false, "animation": ""},
	...
	"hard": {
		...
		"start": [
			{"name": "shield", "value": 200, "animation": ""},
			{"name": "status", "status_name": "deviation", "value": 1, "target": "player", "positive": false, "animation": ""},
			{"name": "status", "status_name": "divine_protection", "value": 50, "target": "self", "positive": true, "extra_args": {"value": 60}, "animation": ""},
		],
		"attack1": [
			{"name": "damage", "value": [55,58], "amount":2, "type": "regular", "animation": "02_atk"},

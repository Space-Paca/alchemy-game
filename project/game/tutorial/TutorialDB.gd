...
const TUTORIAL = {
	...
	"recipe_book": [
		{"position": Vector2(40,100), "dimension": Vector2(990,1005), 
		 "text_side": "right", "text": "Here you'll find all recipes you've learned or found clues on"},
		{"position": Vector2(780,240), "dimension": Vector2(300,550), 
		 "text_side": "right", "text": "Use these tags to filter recipes you know,\nsuch as recipes you can make using reagents in your current hand,\nor using everything inside your bag",
		"text_width": 425},
		{"position": Vector2(500,100), "dimension": Vector2(220,100), 
		 "text_side": "right", "text": "The filters will help you find especific recipes when you have learned lots of them",
		"text_width": 420},
